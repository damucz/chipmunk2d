...
cpSpace *OneWay::Init()
{
    ...
    message = "One way platforms are trivial in Chipmunk using a very simple collision callback.";
...
cpBool OneWay::PreSolve(cpArbiter *arb, cpSpace *space, void *ignore)
{
